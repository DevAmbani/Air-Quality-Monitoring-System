...
def ck_user():
    ...
    Label(root,text="APEX FINANCIAL CORP.",fg="navy",bg="Light blue",font=("Arial Rounded MT Bold",15),width=20).place(x=140,y=320)
...
def ck_user_rq():
    ...
    Label(root,text="APEX FINANCIAL CORP.",fg="navy",bg="Light blue",font=("Arial Rounded MT Bold",15),width=20).place(x=140,y=380)
...
def ad_page():
    ...
    Label(root,text="APEX FINANCIAL CORP.",fg="navy",bg="Light blue",font=("Arial Rounded MT Bold",15),width=20).place(x=140,y=300)
...
def why():
    ...
    Label(root,text="APEX FINANCIAL CORP.",fg="white",bg="Light blue",font=("Arial Rounded MT Bold",15),width=20).place(x=140,y=500)
...
def cp():
    ...
    Label(root,text="APEX FINANCIAL CORP.",fg="navy",bg="Light blue",font=("Arial Rounded MT Bold",15),width=20).place(x=140,y=400)
...
def create():
    ...
    Label(root,text="APEX FINANCIAL CORP.",fg="navy",bg="Light blue",font=("Arial Rounded MT Bold",15),width=20).place(x=140,y=350)
...
def login():
    ...
    Label(root,text="APEX FINANCIAL CORP.",fg="navy",bg="Light blue",font=("Arial Rounded MT Bold",15),width=20).place(x=140,y=370)
...
def term():
    ...
    Label(root,text="APEX FINANCIAL CORP.",fg="navy",bg="Light blue",font=("Arial Rounded MT Bold",15),width=20).place(x=140,y=500)
...
def home():
    ...
    Label(root,text="APEX FINANCIAL CORP.",fg="navy",bg="Light blue",font=("Arial Rounded MT Bold",15),width=20).place(x=140,y=250)
k=-1
cl=0
home()
root.mainloop()
